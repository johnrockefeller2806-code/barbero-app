      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-16">
        ...
        <div className="border-t border-emerald-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link to="/terms-of-service" className="text-emerald-300 hover:text-white text-sm transition-colors">
              {t('footer_terms')}
            </Link>
            <Link to="/privacy-policy" className="text-emerald-300 hover:text-white text-sm transition-colors">
              {t('footer_privacy')}
            </Link>
          </div>
        </div>
