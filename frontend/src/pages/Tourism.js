...
const touristPlaces = [
  {
    ...
    category: "historic",
    images: [
      "https://images.unsplash.com/photo-1651348317504-9513c52e155c?w=800",
      "https://images.unsplash.com/photo-1660913382395-01db15a782b9?w=800",
      "https://images.unsplash.com/photo-1509330336708-10b331f3ae6f?w=800"
    ],
    transport: {
  ...
  },
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1695158147626-dc79be49ede7?w=800",
      "https://images.unsplash.com/photo-1648644828068-20775592fb5c?w=800",
      "https://images.unsplash.com/photo-1664263562176-0b8ab7d89287?w=800"
    ],
    transport: {
  ...
  },
  {
    ...
    category: "historic",
    images: [
      "https://images.unsplash.com/photo-1602061464448-5859b31eb1b8?w=800",
      "https://images.unsplash.com/photo-1644955529419-b4b6c54a1022?w=800",
      "https://images.unsplash.com/photo-1564924126725-8973bcdee2de?w=800"
    ],
    transport: {
  ...
  },
  {
    ...
    category: "attraction",
    images: [
      "https://images.unsplash.com/photo-1724535234360-68cb23990932?w=800",
      "https://images.unsplash.com/photo-1665940482702-f4948fbd30a4?w=800",
      "https://images.unsplash.com/photo-1699791913857-f574fe98be04?w=800"
    ],
    transport: {
      bus: ["13", "40", "123"],
  ...
  },
  {
    ...
    category: "nature",
    images: [
      "https://images.unsplash.com/photo-1598205495006-49eee0df06d0?w=800",
      "https://images.unsplash.com/photo-1725021059787-9f8282df3309?w=800",
      "https://images.unsplash.com/photo-1590198334789-1c2e5cf4ad93?w=800"
    ],
    transport: {
      bus: ["37", "38", "39", "46A", "70"],
  ...
  },
  {
    ...
    category: "historic",
    images: [
      "https://images.unsplash.com/photo-1657065901114-cb84ac4723bf?w=800",
      "https://images.unsplash.com/photo-1657065901218-2af32dbcbd28?w=800",
  ...
  },
  {
    ...
    shops: [
      { name: "Brown Thomas", type: "Loja de Departamento Premium", address: "88-95 Grafton Street", website: "https://www.brownthomas.com", coordinates: { lat: 53.3420, lng: -6.2598 } },
      { name: "Marks & Spencer", type: "Loja de Departamento", address: "15-20 Grafton Street", website: "https://www.marksandspencer.com/ie", coordinates: { lat: 53.3428, lng: -6.2597 } },
      { name: "Zara", type: "Moda", address: "49-52 Grafton Street", website: "https://www.zara.com/ie", coordinates: { lat: 53.3422, lng: -6.2595 } },
      { name: "H&M", type: "Moda", address: "36-38 Grafton Street", website: "https://www.hm.com/ie", coordinates: { lat: 53.3425, lng: -6.2596 } },
      { name: "Penneys (Primark)", type: "Moda Acessível", address: "47 Mary Street (próximo)", website: "https://www.primark.com/ie", coordinates: { lat: 53.3486, lng: -6.2666 } },
      { name: "Weir & Sons", type: "Joalheria", address: "96 Grafton Street", website: "https://www.weirandsons.ie", coordinates: { lat: 53.3419, lng: -6.2599 } },
      { name: "Hodges Figgis", type: "Livraria", address: "56-58 Dawson Street", website: "https://www.hodgesfiggis.ie", coordinates: { lat: 53.3415, lng: -6.2577 } },
      { name: "Arnotts", type: "Loja de Departamento", address: "12 Henry Street", website: "https://www.arnotts.ie", coordinates: { lat: 53.3492, lng: -6.2636 } },
      { name: "Disney Store", type: "Entretenimento", address: "Grafton Street", website: "https://www.shopdisney.eu", coordinates: { lat: 53.3421, lng: -6.2594 } },
      { name: "JD Sports", type: "Esportes", address: "64-66 Grafton Street", website: "https://www.jdsports.ie", coordinates: { lat: 53.3417, lng: -6.2592 } },
      { name: "Sephora", type: "Beleza", address: "Grafton Street", website: "https://www.sephora.ie", coordinates: { lat: 53.3423, lng: -6.2595 } },
      { name: "Tiger", type: "Variedades", address: "Grafton Street", website: "https://flyingtiger.com/ie", coordinates: { lat: 53.3424, lng: -6.2596 } },
      { name: "Carrolls Irish Gifts", type: "Souvenirs", address: "57 Grafton Street", website: "https://www.carrollsirishgifts.com", coordinates: { lat: 53.3418, lng: -6.2593 } },
      { name: "Avoca", type: "Presentes & Café", address: "11-13 Suffolk Street", website: "https://www.avoca.com", coordinates: { lat: 53.3433, lng: -6.2603 } },
      { name: "Bewley's", type: "Café Histórico", address: "78 Grafton Street", website: "https://www.bewleys.com", coordinates: { lat: 53.3414, lng: -6.2591 } }
    ],
    nearbyRestaurants: [
            ...
            <>
              ...
              <div className="p-6">
                ...
                <Tabs value={detailTab} onValueChange={setDetailTab}>
                  <TabsList className={`grid mb-4 ${selectedPlace.shops ? 'grid-cols-5' : 'grid-cols-4'}`}>
                    ...
                    {selectedPlace.shops && (
                      <TabsTrigger value="shops" className="text-xs md:text-sm">
                        🛍️
                        {language === 'pt' ? ' Lojas' : ' Shops'}
                      </TabsTrigger>
                    )}
                  ...
                  {/* Shops Tab - Only for places with shops */}
                  {selectedPlace.shops && (
                    <TabsContent value="shops" className="space-y-4">
                      <div>
                        <h4 className="font-semibold mb-3 flex items-center gap-2">
                          🛍️ {language === 'pt' ? 'Lojas em Grafton Street' : 'Shops on Grafton Street'}
                        </h4>
                        <p className="text-sm text-gray-500 mb-4">
                          {language === 'pt' 
                            ? 'Clique em uma loja para abrir no Google Maps ou acessar o site oficial'
                            : 'Click on a shop to open in Google Maps or visit the official website'}
                        </p>
                        <div className="space-y-2 max-h-96 overflow-y-auto">
                          {selectedPlace.shops.map((shop, idx) => (
                            <div 
                              key={idx} 
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                <Button
                                  ...
                                  onClick={() => {
                                    const url = `https://www.google.com/maps/search/?api=1&query=${shop.coordinates.lat},${shop.coordinates.lng}`;
                                    window.open(url, '_blank');
                                  }}
                                >
