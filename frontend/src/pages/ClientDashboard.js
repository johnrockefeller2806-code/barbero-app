...
import { Search, MapPin, Star, Clock, Users, LogOut, Filter, Navigation, Scissors, User, Home, Car, Banknote, CreditCard, Share2, Gift, Instagram, Radio, MapPinOff, Calendar, CalendarClock, Heart, X, Camera } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                onClick={() => {
                  const shareText = '💈 Conhece o ClickBarber? Encontre barbeiros perto de você em Dublin! 🇮🇪\n\n✂️ Corte na barbearia ou em casa\n📍 Veja no mapa em tempo real\n\nBaixa agora: ' + window.location.origin;
                  if (navigator.share) {
                    navigator.share({
                      title: 'ClickBarber',
                      text: shareText,
